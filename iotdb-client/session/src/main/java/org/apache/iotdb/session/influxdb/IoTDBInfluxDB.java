...
public abstract class IoTDBInfluxDB implements InfluxDB {
  ...
  //    }
  //    influxDBService = new IoTDBInfluxDBService(uri.getHost(), uri.getPort(), userName,
  // password);
  //  }
  //
  ...
  //
  //  @Override
  //  public void query(Query query, int chunkSize, Consumer<QueryResult> onNext, Runnable
  // onComplete) {
  //    throw new UnsupportedOperationException(InfluxDBConstant.METHOD_NOT_SUPPORTED);
  //  }
  //
